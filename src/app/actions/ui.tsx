...
export const UiActions = {
  ...
  visBaksystemFeilmelding: createStandardAction(UiTypeKeys.VIS_BAKSYSTEM_FEILMELDING)<
    BaksystemFeilmelding
  >(),
  sjekkTidligereMeldekort: createStandardAction(UiTypeKeys.SJEKK_TIDLIGERE_MELDEKORT)<
