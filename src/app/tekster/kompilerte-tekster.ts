/*tslint:disable*/ export default {
    nb: {
        ...
        annetFravar: ' ',
        'arbeidTimer.heleEllerHalveTallValidator': 'Antall timer er ugyldig. Gyldige verdier er hele og halve timer ',
        ...
        'forklaring.sporsmal.ferieFravar-AAP':
            'Du skal svare <strong>Ja</strong> hvis du ikke har kunnet ta arbeid eller gjennomføre avtalt aktivitet, og dette ikke skyldes at du har vært syk.  <br> <br> Det gjelder f.eks. hvis du har hatt ferie og derfor ikke kunnet gjennomføre avtalt aktivitet. Det gjelder også opphold i utlandet som ikke er godkjent av NAV. <br> <br> Du skal svare <strong>Ja</strong> hvis du ikke har avtalt noen aktivitet med NAV i perioden, og ikke er tilgjengelig for NAV mens du skal være borte.  <br> <br> Fravær vil normalt føre til trekk i utbetalingen.   <br> <br> Hvis du vil beholde arbeidsavklaringspengene i den perioden du er borte, må du ta kontakt med NAV i god tid på forhånd. <br> <br> Hvis sterke velferdsgrunner er årsaken til fraværet, kan NAV vurdere om du likevel kan få penger. Du må kontakte NAV første fraværsdag. <br> <br> Hvis du ikke har hatt ferie eller annet fravær, svarer du <strong>Nei</strong>. <br> <br> Du skal også svare <strong>Nei</strong> dersom du har oppholdt deg i utlandet og utenlandsoppholdet har blitt godkjent av NAV. ',
        'forklaring.sporsmal.ferieFravar':
            'Du skal svare <strong>Ja</strong> hvis det er andre grunner enn egen sykdom til at du ikke har kunnet ta arbeid, delta på tiltak eller være arbeidssøker. Med tiltak mener vi arbeidsmarkedstiltak som for eksempel AMO-kurs eller Jobbklubb.  <br> <br> Du skal også svare <strong>Ja</strong> hvis du ikke ønsker å være tilgjengelig for arbeidsmarkedet eller NAV på dager uten planlagt aktivitet.  <br> <br> Du skal svare <strong>Ja</strong> hvis du oppholder deg i utlandet. Du har ikke rett til dagpenger mens du oppholder deg i utlandet, med mindre NAV på forhånd har godkjent at du er dekket av en av unntaksreglene. <br> <br> Fravær vil normalt føre til trekk i utbetalingen.  <br> <br> Til deg som får tiltakspenger: er årsaken til fraværet jobbintervju, timeavtale i det offentlige hjelpeapparatet eller sterke velferdsgrunner, kan du likevel ha rett til tiltakspenger. Kontakt NAV første fraværsdag. <br> <br> Hvis du ikke har hatt fravær, svarer du <strong>Nei</strong>. ',
        ...
        'forklaring.utfylling.ferieFravar-AAP':
            'Du skal registrere de dagene du ikke har kunnet ta arbeid eller gjennomføre avtalt aktivitet, og dette skyldes annet enn egen sykdom.  <br> <br> Det gjelder f.eks. hvis du har hatt ferie og derfor ikke kunnet gjennomføre avtalt aktivitet. <br> <br> Det gjelder også opphold i utlandet som ikke er godkjent av NAV <br> <br> Det gjelder også dersom du ikke ønsker å være tilgjengelig for NAV på dager uten planlagt aktivitet.  <br> <br> Hvis du likevel ønsker å få arbeidsavklaringspenger for fraværsdagene, må du kontakte NAV før fraværet starter. ',
        ...
        'forklaring.utfylling.syk':
            'Du skal registrere de dagene du har vært forhindret fra å ta arbeid på grunn av egen sykdom.  <br> <br> Du skal registrere de dagene du har vært for syk til å delta på tiltak, kurs eller utdanning du har avtalt med NAV. ',
        ...
        'genereltOmMeldekort.valg.endre': 'Endre meldeform fra f.eks. papirmeldekort til elektronisk meldekort ',
        ...
        'melding.loggInn': 'Du er ikke logget inn. Vi viderefører deg til innloggingsiden når du lukker denne boksen. ',
        ...
        'oss.sende.tekst':
            '<p> Du skal sende meldekortet på fastsatt meldingsdag. Det er mandag etter perioden på kortet (mandag i uke 3). På nav.no kan du sende meldekortet allerede den siste lørdag/søndag i perioden på kortet (lørdag/søndag i uke 2). </p> <p> På "Din side" ser du når neste meldekort kan sendes. </p> ',
        'oss.utbetalt.overskrift': 'Hvor mye får jeg utbetalt? ',
        'oss.utbetalt.tekst':
            '<p> Når meldekortet er beregnet, ser du brutto beregnet ytelse på «Din side». </p> <p> Brutto beløp er ytelsen før skattetrekk og eventuelle andre trekk. Beløpet er beregnet ut i fra hvilken dagsats du har, samt eventuelle tilleggsopplysninger du har oppgitt på meldekortet. </p> <p> Vil du ha flere detaljer om de ytelsene som er beregnet og mer om hva som er trukket i skatt eller av andre grunner, ser du det i «Dine utbetalinger». </p> ',
        ...
        'overskrift.dinSide': 'Gå til Din side ',
        ...
        'sendMeldekort.info.eldstePerioden': 'Meldekortet du sender vil alltid være for den eldste perioden. ',
        ...
        'sendMeldekort.info.innsendingStatus.sendesSenest': '<span class="orange">Sendes inn senest:</span> ',
        'sendMeldekort.info.innsendingStatus.sendesSnarest': '<span class="orange">Sendes inn snarest!</span> ',
        ...
        'sporsmal.aktivitetArbeid-AAP': 'Har du gjennomført avtalt aktivitet eller deltatt på kurs/utdanning? ',
        ...
        'svar.aktivitetArbeid.ja-AAP': 'Ja, jeg har gjennomført avtalt aktivitet eller deltatt på kurs/utdanning ',
        ...
        'utfylling.bekreft.feil': 'Bekreftelse for at du har lest og forstått veiledningstekstene må fylles ut. ',
    ...
    en: {
        ...
        'endreMeldeform.info': 'You can choose between electronic employment status form  and paper status form ',
        'endreMeldeform.kvittering.elektronisk.info':
        ...
        'forklaring.sporsmal.begrunnelse':
            'In order to correct the employment status form you have to state a reason. We will contact you if we need further information or documentation.  If you need to give a more detailed explanation, you may write to NAV by choosing the option «Send beskjed til NAV» from the menu at Ditt NAV. ',
        'forklaring.sporsmal.ferieFravar-AAP':
            'Click <strong>Yes </strong>if other reasons than your own illness have made you unable to take on work or participate in agreed activities.  <br> <br> This applies e.g. to Holidays. This also applies if you stay abroad without NAVs approval. <br> <br> Click <strong>Yes</strong> if you wish to be unavailable for NAV or for taking on work during days without any agreed activities. <br> <br> Absence will as a rule reduce benefits. <br> <br> NAV can consider whether you may still receive the benefit. Please contact NAV on the first day of absence.  <br> <br> NAV can determine whether you may continue to receive benefits, if your absence is due to special personal reasons. Contact NAV the first day of absence. <br> <br> If you have not been absent or unavailable, click <strong>No</strong>. <br> <br> Click <strong>No</strong> if you stay abroad and this has been preapproved by NAV. ',
        'forklaring.sporsmal.ferieFravar':
            'Click  <strong>Yes</strong> if other reasons than your own illness have made you unable to take on work, participate in employment schemes or be a job seeker. By measures we mean labour market measures such as an AMO course or a Job Club. <br> <br> Click <strong>Yes</strong> if you wish to be unavailable for NAV or for taking on work during days without any agreed activities.  <br> <br> Click <strong>Yes</strong> if you stay abroad. You are not entitled to unemployment benefits unless NAV has previously stated that you are covered by one of the exceptions from the main rule. <br> <br> Absence normally leads to reduced benefits.  <br> <br> Do you receive benefits while participating in employment schemes? If your absence is due to a job interview, appointment with public support services or special personal reasons, NAV can consider whether you may still receive the benefit. Please contact NAV on the first day of absence.  <br> <br> If you have not been absent or unavailable, click <strong>No</strong>. ',
        'forklaring.sporsmal.forhindret-AAP':
        ...
        'forklaring.sporsmal.forhindret':
            'Click <strong>Yes</strong> if you have been prevented from taking work. <br> <br> Click <strong>Yes</strong> if you have been too ill to participate in employment schemes, courses or training/education that you and NAV have agreed on. <br> <br> Click <strong>No</strong> if you have not been too ill. <br> <br> Do you receive unemployment benefits? You can still receive unemployment benefits if you are ill, but you need a sick note from a medical doctor. If you receive a graded sick note of 50 percent or less, click <strong>No</strong>. The illness allowance and the unemployment benefits will be coordinated. ',
        'forklaring.sporsmal.registrert-AAP':
        ...
        'forklaring.utfylling.ferieFravar-AAP':
            'You need to register if other reasons than your illness have made you unable to take on jobs or to participate in agreed activities. <br> <br> This applies e.g. to Holidays. This also applies if you stay abroad without NAVs approval. <br> <br> This also applies if you wish to be unavailable to NAV on days without any agreed activities.  <br> <br> If you want to keep your work assessment allowance during absence, you have to contact NAV. ',
        'forklaring.utfylling.ferieFravar':
            'You need to register if other reasons than your illness have made you unable to take on jobs. <br> <br> You must also register days you have been unable to participate in labour measures, courses or training/education that you and NAV have agreed on. <br> <br> This also applies if you wish to be unavailable to NAV or taking on jobs during days without any agreed activities.  <br> <br> Absence normally leads to reduced benefits. <br> <br> You are not entitled to unemployment benefits as long as you stay abroad, unless NAV in advance has accepted that you are covered by an exception rule. You must check the days you stay abroad. ',
        'forklaring.utfylling.syk-AAP':
        ...
        'forklaring.utfylling.syk':
            'You need to register the days you have unable to take on work due to illness. <br> <br> This also applies if you have been too ill to participate in labour measures, courses or training/education that you and NAV have agreed on. ',
        'forklaring.utfylling.tiltak-AAP':
            'You need to register the days you have participated in activities you and NAV have agreed on.  <br> This includes <ul> <li>employment schemes</li> <li>active medical treatment</li> <li>training or education</li> <li>other activities</li> </ul> <br> You also need to register days you have participated in a course, education/training or self-study that you and NAV have not agreed upon. ',
        'forklaring.utfylling.tiltak':
            'You need to register the days you have participated in employment schemes, courses or training/education that you and NAV have agreed on.  <br> <br> You also need to register days you have participated in a course, education/training or self-study that you and NAV have not agreed upon. <br> <br> If NAV has approved that you can receive unemployment benefits while you are attending an educational program, you need to register these days as well. <br> <br> Are you attending part time measures and schemes, and receiving benefits while participating in employment schemes? Contact NAV for information on what to register. ',
        ...
        'oss.sende.tekst':
            '<p> You must submit the employment status form at the scheduled submission day. Scheduled submission day is the first Monday after the period on the status form (Monday week 3). You may already submit the employment status form the last Saturday or Sunday on the status form (Saturday/Sunday week 2). </p> <p> You find your next submission deadline at “Din side”. </p> ',
