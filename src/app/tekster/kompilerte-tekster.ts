/*tslint:disable*/ export default {
  nb: {
    ...
    'forklaring.sporsmal.arbeid':
      'Du skal svare <strong>Ja</strong> hvis du har vært i arbeid. Det gjelder både lønnet og ulønnet arbeid. <br><br> <b><p style="color:#ee5522;">  Har du hjemmekontor og jobber, skal du føre opp arbeid på vanlig måte. Har du fravær fra jobb på grunn av karantene, men får betalt lønn, skal du føre opp de timene du skulle ha jobbet. <br><br> Dersom du mottar dagpenger og tar jobb innenfor jordbruk, skogbruk og gartneri skal du kun føre halvparten av timene du har arbeidet med dette på meldekortet. Mer informasjon om hvilken type jobb innenfor landbruk, skogbruk og gartneri som omfattes finner du <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">her</a>. </b></p> <br> Det gjelder arbeid som <ul><li> arbeidstaker </li><li> oppdragstaker </li> <li> mottaker av omsorgslønn </li> <li> arbeid i egen næringsvirksomhet  </li> </ul> <br> Dette gjelder alle dager i uken, også lørdag og søndag, uansett når på døgnet du jobber. <br><br>Hvis du jobber turnus eller skift, skal du registrere et gjennomsnitt for turnusperioden. Ta kontakt med NAV. <br><br>Dersom du mottar naturalytelser, som fri telefon, avis m.m., skal disse ikke omregnes til timer som skal føres på meldekortet. Det innebærer at naturalytelser du mottar ikke vil påvirke dagpengene dine. <br><br>Til deg som får dagpenger:  Det gjelder egne regler for ulønnet arbeid av hobbypreget eller sosial karakter. Kontakt NAV om dette.<br><br>I noen tiltak får du lønn. Avtal med  NAV om du skal krysse av for arbeid og hvilke timer du skal føre opp.<br><br>Du skal svare <strong>Nei</strong> hvis du ikke har vært i arbeid. ',
    ...
    'forklaring.sporsmal.ferieFravar':
      'Du skal svare <strong>Ja</strong> hvis det er andre grunner enn egen sykdom til at du ikke har kunnet ta arbeid, delta på tiltak eller være arbeidssøker. Med tiltak mener vi arbeidsmarkedstiltak som for eksempel AMO-kurs eller Jobbklubb. <br><br> <b><p style="color:#ee5522;">  Du skal svare Nei om du ikke kan jobbe eller delta på aktiviteter på grunn av smitte eller av hensyn til smittevern.  </b></p> <br> Du skal også svare <strong>Ja</strong> hvis du ikke ønsker å være tilgjengelig for arbeidsmarkedet eller NAV på dager uten planlagt aktivitet. <br> <br> Du skal svare <strong>Ja</strong> hvis du oppholder deg i utlandet. Du har ikke rett til dagpenger mens du oppholder deg i utlandet, med mindre NAV på forhånd har godkjent at du er dekket av en av unntaksreglene. <br> <br> Fravær vil normalt føre til trekk i utbetalingen. <br> <br> Til deg som får tiltakspenger: er årsaken til fraværet jobbintervju, timeavtale i det offentlige hjelpeapparatet eller sterke velferdsgrunner, kan du likevel ha rett til tiltakspenger. Kontakt NAV første fraværsdag. <br> <br> Hvis du ikke har hatt fravær, svarer du <strong>Nei</strong>. ',
    'forklaring.sporsmal.forhindret-AAP':
      'Du skal svare <strong>Ja</strong> hvis du har vært forhindret fra å ta arbeid eller gjennomføre den aktiviteten du har avtalt med NAV fordi du har vært for syk. <br><br> <b><p style="color:#ee5522;"> Fravær fra jobb på grunn av karantene føres på samme måte som sykdom (gjelder ikke ved hjemmekontor). </p></b> <br><br> Med aktivitet mener vi <ul> <li> arbeid </li> <li> arbeidsrettede tiltak </li> <li> medisinsk behandling </li> <li> kurs/utdanning/selvstudium </li> <li> annen aktivitet </li> </ul> Du skal svare <strong>Nei</strong> hvis du ikke har hatt fravær på grunn av sykdom. ',
    'forklaring.sporsmal.forhindret':
      'Du skal svare <strong>Ja</strong> hvis du har vært syk og derfor har vært forhindret fra å ta arbeid. <br><br> <b><p style="color:#ee5522;">  Du skal ikke svare ja med mindre du er sykmeldt og skal ha sykepenger.  </b></p> <br> Du skal svare <strong>Ja</strong> hvis du har vært for syk til å delta på tiltak, kurs eller utdanning som du har avtalt med NAV. <br> <br> Du skal svare <strong>Nei</strong> hvis du ikke har vært syk. <br> <br> Til deg som får dagpenger: Blir du syk, kan du få sykepenger hvis du blir sykmeldt av lege. Får du gradert sykmelding på 50 prosent eller mindre, skal du svare <strong>Nei</strong> på dette spørsmålet. Sykepengene og dagpengene vil bli samordnet. ',
    ...
    'forklaring.utfylling.ferieFravar':
      '<b><p style="color:#ee5522;"> Om du ikke kan jobbe eller delta på aktiviteter på grunn av smitte eller av hensyn til smittevern, skal det ikke føre til trekk i dagpenger eller tiltakspenger. På meldekortet skal du derfor ikke registrere slikt fravær. </p></b>  Du skal registrere de dagene du har vært forhindret fra å ta arbeid av andre grunner enn egen sykdom. <br> <br> Du skal registrere dager du ikke har kunnet delta på tiltak, kurs eller utdanning. <br> <br> Det gjelder også dersom du ikke ønsker å være tilgjengelig for arbeidsmarkedet eller NAV på dager uten planlagt aktivitet. <br> <br> Fravær vil normalt føre til trekk i utbetalingen. <br> <br> Du har ikke rett til dagpenger mens du oppholder deg i utlandet, med mindre NAV på forhånd har godkjent at du er dekket av en av unntaksreglene. Du må krysse av på de dagene du oppholder deg i utlandet. ',
    ...
    'forklaring.utfylling.syk':
      '<b><p style="color:#ee5522;">  Du skal ikke skal registrere sykdom med mindre du er sykmeldt og skal ha sykepenger.  </p></b> Du skal registrere de dagene du har vært forhindret fra å ta arbeid på grunn av egen sykdom. <br> <br> Du skal registrere de dagene du har vært for syk til å delta på tiltak, kurs eller utdanning du har avtalt med NAV. ',
    ...
    'sporsmal.ansvarForRiktigUtfylling':
      'Du må oppgi riktige og fullstendige opplysninger. Gjør du ikke det kan det føre til at du må betale tilbake det du feilaktig har fått utbetalt. Du kan også bli anmeldt til politiet. <br><br> <b><p style="color:#ee5522;"> Det er en del endringer for hvordan du skal føre arbeid, aktivitet og fravær på ifm. koronasituasjonen. Mer informasjon finner du <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">her</a>. <br><br> Se også informasjon i veiledningstekstene markert med rød skrift. </p></b> ',
  ...
  en: {
    ...
    'forklaring.sporsmal.aktivitetArbeid':
      'Click <strong>Yes</strong> if you have participated in employment schemes, courses or training/education. With employment schemes we mean labour market schemes such as an AMO course or a Job Club. Do not record other activities from your activity plan, such as information meetings with NAV or jobs you have applied for. <br><br> <b><p style="color:#ee5522;">  Register the days you should have participated in activities, courses or education, but were unable to participate due to contagion or contagion-preventing measures.  <b></p> <br> Click <strong>Yes</strong> if NAV has approved you receiving unemployment benefits while attending education. <br> <br> Click <strong>Yes</strong> if you have attended courses or education that you have not agreed upon with NAV. This also applies to self-study. <br> <br> Click <strong>No</strong> If you have not participated in employment schemes, courses or training/education. ',
    'forklaring.sporsmal.arbeid-AAP':
    ...
    'forklaring.sporsmal.arbeid':
      'Click <strong>Yes</strong> if you have worked. Work includes both paid and unpaid labour. <br><br> <b><p style="color:#ee5522;">  If you work from home, register your hours like you normally would. If you are absent from work due to quarantine, but still receive payment, register the hours that you should have worked. <br><br> If you receive unemployment benefits and work within agriculture, forestry or plant nursery, register only half the hours spent working on this. More information on what types of work are included is available <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">here (norwegian only)</a> </b></p> <br><br> This includes work as <ul> <li> employee </li> <li> contactor </li> <li> Recipient of cash benefits for care </li> <li> self-employed </li>  </ul> This applies to all days of the week, including Saturday and Sunday, regardless if it is day, evening or night. <br> <br> If you work shifts, you register the average of hours per shift for the term. <br> <br> Do you receive unemployment benefits? Be aware that separate rules apply for unpaid labour of social or hobby-like nature. <br> <br> In some employment schemes you receive payment. You and NAV must then agree upon which hours you should register. <br> <br> Click <strong>No</strong> if you have not been working. ',
    'forklaring.sporsmal.begrunnelse-AAP':
    ...
    'forklaring.sporsmal.ferieFravar':
      'Click  <strong>Yes</strong> if other reasons than your own illness have made you unable to take on work, participate in employment schemes or be a job seeker. By measures we mean labour market measures such as an AMO course or a Job Club. <br><br> <b><p style="color:#ee5522;"> Tick No if you are unable to work or participate in activities due to contagion or as a result of contagion-preventing measures. <b></p> <br> Click <strong>Yes</strong> if you wish to be unavailable for NAV or for taking on work during days without any agreed activities. <br> <br> Click <strong>Yes</strong> if you stay abroad. You are not entitled to unemployment benefits unless NAV has previously stated that you are covered by one of the exceptions from the main rule. <br> <br> Absence normally leads to reduced benefits. <br> <br> Do you receive benefits while participating in employment schemes? If your absence is due to a job interview, appointment with public support services or special personal reasons, NAV can consider whether you may still receive the benefit. Please contact NAV on the first day of absence. <br> <br> If you have not been absent or unavailable, click <strong>No</strong>. ',
    'forklaring.sporsmal.forhindret-AAP':
      'Click <strong>Yes</strong> if you have been prevented from taking work or performing an agreed activity due to illness. <br><br> <b><p style="color:#ee5522;"> Absence from work due to quarantine should be registered in the same way as sick leave. This does not apply when working from home. </p></b> <br><br> This applies to <ul> <li>employment schemes </li> <li>active medical treatment </li> <li>courses/training, education/self-study </li> <li>other activities </li> </ul> Click <strong> No</strong> if you have not had any absence due to illness. ',
    'forklaring.sporsmal.forhindret':
      'Click <strong>Yes</strong> if you have been prevented from taking work. <br><br> <b><p style="color:#ee5522;">  Do not register illness unless you have sick leave and receive illness benefits.  <b></p> <br> Click <strong>Yes</strong> if you have been too ill to participate in employment schemes, courses or training/education that you and NAV have agreed on. <br> <br> Click <strong>No</strong> if you have not been too ill. <br> <br> Do you receive unemployment benefits? You can still receive unemployment benefits if you are ill, but you need a sick note from a medical doctor. If you receive a graded sick note of 50 percent or less, click <strong>No</strong>. The illness allowance and the unemployment benefits will be coordinated. ',
    'forklaring.sporsmal.registrert-AAP':
    ...
    'forklaring.utfylling.arbeid':
      '<b><p style="color:#ee5522;">  If you work from home, register your hours like you normally would. If you are absent from work due to quarantine, but still receive payment, register the hours that you should have worked. <br><br> If you receive unemployment benefits and work within agriculture, forestry or plant nursery, register only half the hours spent working on this. More information on what types of work are included is available <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">here (norwegian only)</a> </p></b> You must register the hours you have been working, both paid und unpaid, even if you are self-employed. This applies to all days of the week, including Saturday and Sunday, regardless if it is day, evening or night. <br> <br> The exception is if you are paid for a higher number of hours than you have actually worked. You then need to register the amount of hours you are paid for. <br> <br> If you work a specific percentage, convert it to hours. A full time job is normally 37,5 hours per week. <br> <br> If you work exactly 50 percent, you register 18,5 hours one week, and 19 hours the next. <br> <br> If you work shifts, you register the average of hours per shift for the term. <br><br> If you receive payment in kind, such as free phone service, newspaper etc., do not calculate this into hours to be registered in the form. Payment in kind will not influence the amount of the unemployment benefit you receive. <br><br> Please contact NAV if you <ul> <li> are unsure how many hours to register </li> <li> participate in part-time employment schemes or measures where you receive payment </li> <ul> ',
    'forklaring.utfylling.ferieFravar-AAP':
    ...
    'forklaring.utfylling.ferieFravar':
      '<b><p style="color:#ee5522;">  If you are unable to work or participate in activities due to contagion or as a result of contagion-preventing measures, this will not be deducted from your benefits. Therefore, do not register this as absence. </p></b> You need to register if other reasons than your illness have made you unable to take on jobs. <br> <br> You must also register days you have been unable to participate in labour measures, courses or training/education that you and NAV have agreed on. <br> <br> This also applies if you wish to be unavailable to NAV or taking on jobs during days without any agreed activities. <br> <br> Absence normally leads to reduced benefits. <br> <br> You are not entitled to unemployment benefits as long as you stay abroad, unless NAV in advance has accepted that you are covered by an exception rule. You must check the days you stay abroad. ',
    'forklaring.utfylling.syk-AAP':
    ...
    'forklaring.utfylling.syk':
      '<b><p style="color:#ee5522;">  Do not register illness unless you have sick leave and receive illness benefits. </p></b>  You need to register the days you have unable to take on work due to illness. <br> <br> This also applies if you have been too ill to participate in labour measures, courses or training/education that you and NAV have agreed on. ',
    'forklaring.utfylling.tiltak-AAP':
    ...
    'forklaring.utfylling.tiltak':
      '<b><p style="color:#ee5522;">  Register the days you should have participated in courses, but were unable to participate due to contagion or contagion-preventing measures.  </p></b>  You need to register the days you have participated in employment schemes, courses or training/education that you and NAV have agreed on. <br> <br> You also need to register days you have participated in a course, education/training or self-study that you and NAV have not agreed upon. <br> <br> If NAV has approved that you can receive unemployment benefits while you are attending an educational program, you need to register these days as well. <br> <br> Are you attending part time measures and schemes, and receiving benefits while participating in employment schemes? Contact NAV for information on what to register. ',
    ...
    'sporsmal.ansvarForRiktigUtfylling':
      'If the information you provide is not correct and complete, this may mean that you must pay back what you have received erroneously. You may also be reported to the police. <br><br> <b><p style="color:#ee5522;"> Due to the situation with corona, there have been some changes to how you should register work, activity and absence. More information is available <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">here (norwegian only)</a>. <br><br> See also information in the guidance texts marked with a red font. </p></b> ',
    ...
    'sporsmal.ferieFravar':
      'Has holiday or other absence made you unable to take on work, participating in employment schemes or being a job seeker? ',
    'sporsmal.forhindret-AAP':
    ...
    'svar.ferieFravar.ja':
      'Yes, I have been on holiday or otherwise absent, and thus unable to take on work, participating in employment schemes or being a job seeker ',
    'svar.ferieFravar.nei-AAP':
      'No, I have not been on holiday or other absence that made me unable to take on work or perform an agreed activity ',
    'svar.ferieFravar.nei':
      'No, I have not been on holiday or otherwise absent, and thus unable to take on work, participating in employment schemes or being a job seeker ',
    'svar.forhindret.ja-AAP':
