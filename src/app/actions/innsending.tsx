...
export const InnsendingActions = {
  ...
  oppdaterMeldekortdetaljer: createStandardAction(InnsendingTypeKeys.OPPDATER_MELDEKORTDETALJER)<
    Meldekortdetaljer
  >(),

  resetInnsending: createStandardAction(InnsendingTypeKeys.RESET_INNSENDING)<void>(),
  resetSporsmalOgUtfylling: createStandardAction(InnsendingTypeKeys.RESET_SPORSMAL_OG_UTFYLLING)<
    void
  >(),
  ...
  settValideringsresultat: createStandardAction(InnsendingTypeKeys.SETT_VALIDERINGSRESULTAT)<
    ValideringsResultat
  >(),
  resetValideringsresultat: createStandardAction(InnsendingTypeKeys.RESET_VALIDERINGSRESULTAT)<
    void
  >(),
};
