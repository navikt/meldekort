/*tslint:disable*/ export default {
  ...
  en: {
    ...
    'forklaring.utfylling.syk':
      '<b><p style="color:#ee5522;">  Do not register illness unless you are on sick leave and receive illness benefits.  </p></b>  You need to register the days you have unable to take on work due to illness. <br> <br> This also applies if you have been too ill to participate in labour measures, courses or training/education that you and NAV have agreed on. ',
    'forklaring.utfylling.tiltak-AAP':
      '<b><p style="color:#ee5522;">  Register the days you should have participated in activities.  </p></b>  You need to register the days you have participated in activities you and NAV have agreed on. <br> This includes <ul> <li>employment schemes</li> <li>active medical treatment</li> <li>training or education</li> <li>other activities</li> </ul> <br> You also need to register days you have participated in a course, education/training or self-study that you and NAV have not agreed upon. ',
    'forklaring.utfylling.tiltak':
      '<b><p style="color:#ee5522;">  Register the days you should have participated in courses.  </p></b>  You need to register the days you have participated in employment schemes, courses or training/education that you and NAV have agreed on. <br> <br> You also need to register days you have participated in a course, education/training or self-study that you and NAV have not agreed upon. <br> <br> If NAV has approved that you can receive unemployment benefits while you are attending an educational program, you need to register these days as well. <br> <br> Are you attending part time measures and schemes, and receiving benefits while participating in employment schemes? Contact NAV for information on what to register. ',
