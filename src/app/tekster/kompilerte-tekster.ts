/*tslint:disable*/ export default {
  nb: {
    ...
    'forklaring.sporsmal.forhindret-AAP':
      'Du skal svare <strong>Ja</strong> hvis du har vært forhindret fra å ta arbeid eller gjennomføre den aktiviteten du har avtalt med NAV fordi du har vært for syk. <br> <br> Med aktivitet mener vi <ul> <li> arbeid </li> <li> arbeidsrettede tiltak </li> <li> medisinsk behandling </li> <li> kurs/utdanning/selvstudium </li> <li> annen aktivitet </li> </ul> Du skal svare <strong>Nei</strong> hvis du ikke har hatt fravær på grunn av sykdom. ',
    ...
    'forklaring.utfylling.syk-AAP':
      'Du skal registrere de dagene du ikke har kunnet ta arbeid eller gjennomføre avtalt aktivitet fordi du har vært for syk. <br> <b><p style="color:#ee5522;"> Fravær fra jobb på grunn av karantene føres på samme måte som sykdom (gjelder ikke ved hjemmekontor). </b></p>  <br> Dette gjelder dager du har vært for syk til å delta på <ul> <li> arbeidsrettede tiltak </li> <li> medisinsk behandling </li> <li> kurs/utdanning/selvstudium </li> <li> annen aktivitet </li> </ul> ',
    ...
    'sporsmal.lesVeiledning':
      'Du må lese veiledningstekstene før du fyller ut feltene i meldekortet. Du finner dem ved å klikke på "Les mer" under hvert spørsmål. <br><br> <b><p style="color:#ee5522;"> Det er en del endringer for hvordan du skal føre arbeid, aktivitet og fravær på ifm. koronasituasjonen. Mer informasjon finner du <a target="_blank" href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/koronavirus--informasjon-fra-nav/hva-skal-jeg-fore-pa-meldekortet">her</a>. <br><br> Se også informasjon i veiledningstekstene markert med rød skrift. </p></b> ',
  ...
  en: {
    ...
    'forklaring.sporsmal.forhindret-AAP':
      'Click <strong>Yes</strong> if you have been prevented from taking work or performing an agreed activity due to illness. <br> <br> This applies to  <ul> <li>employment schemes </li> <li>active medical treatment </li> <li>courses/training, education/self-study </li> <li>other activities </li> </ul> Click <strong> No</strong> if you have not had any absence due to illness. ',
    'forklaring.sporsmal.forhindret':
