/*tslint:disable*/ export default {
  ...
  en: {
    ...
    'forklaring.sporsmal.aktivitetArbeid':
      'Click <strong>Yes</strong> if you have participated in employment schemes, courses or training/education. With employment schemes we mean labour market schemes such as an AMO course or a Job Club. Do not record other activities from your activity plan, such as information meetings with NAV or jobs you have applied for. <br><br> <b><p style="color:#ee5522;">  Register the days you should have participated in activities, but were unable to participate due to contagion or contagion-preventing measures.  <b></p> <br> Click <strong>Yes</strong> if NAV has approved you receiving unemployment benefits while attending education. <br> <br> Click <strong>Yes</strong> if you have attended courses or education that you have not agreed upon with NAV. This also applies to self-study. <br> <br> Click <strong>No</strong> If you have not participated in employment schemes, courses or training/education. ',
    'forklaring.sporsmal.arbeid-AAP':
    ...
    'forklaring.utfylling.arbeid':
      '<b><p style="color:#ee5522;">  If you work from home, register your hours like you normally would. If you are absent from work due to quarantine, but still receive payment, register the hours that you should have worked. </p></b> You must register the hours you have been working, both paid und unpaid, even if you are self-employed. This applies to all days of the week, including Saturday and Sunday, regardless if it is day, evening or night. <br> <br> The exception is if you are paid for a higher number of hours than you have actually worked. You then need to register the amount of hours you are paid for. <br> <br> If you work a specific percentage, convert it to hours. A full time job is normally 37,5 hours per week. <br> <br> If you work exactly 50 percent, you register 18,5 hours one week, and 19 hours the next. <br> <br> If you work shifts, you register the average of hours per shift for the term. <br> <br> Please contact NAV if you <ul> <li> are unsure how many hours to register </li> <li> participate in part-time employment schemes or measures where you receive payment </li> <ul> ',
    'forklaring.utfylling.ferieFravar-AAP':
      '<b><p style="color:#ee5522;">  Absence from work due to quarantine should be registered in the same way as absence due to illness. Working from home is not considered absence. </p></b>  You need to register if other reasons than your illness have made you unable to take on jobs or to participate in agreed activities. <br> <br> This applies e.g. to Holidays. This also applies if you stay abroad without NAVs approval. If you are a national of an EU/EEA-country and you have a temporary residence in another EU/EEA- country, you will not need approval by NAV. <br> <br> This also applies if you wish to be unavailable to NAV on days without any agreed activities. <br> <br> If you want to keep your work assessment allowance during absence, you have to contact NAV. ',
    'forklaring.utfylling.ferieFravar':
    ...
    'forklaring.utfylling.syk-AAP':
      'You need to register the days you have unable to take on work or perform an agreed activity due to illness. <br> <br> This applies to days you have been too ill to participate in <ul> <li>measures and schemes </li> <li>active medical treatment </li> <li>training/education </li> <li>other agreed activities </li> </ul> ',
    'forklaring.utfylling.syk':
